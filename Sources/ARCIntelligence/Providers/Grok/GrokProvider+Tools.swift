...
extension GrokProvider: ToolProvider {
...
private struct GrokToolCallingContext {
...
extension GrokProvider {
    private func executeToolLoop(context: GrokToolCallingContext,
    ...
    private func buildToolRequest(context: GrokToolCallingContext,
